package top.xxxlu.hotinfo.imagebrowser;
...
import top.xxxlu.hotinfo.utils.AACamera;
import top.xxxlu.hotinfo.utils.AAComAdapter;
import top.xxxlu.hotinfo.utils.AADate;
import top.xxxlu.hotinfo.utils.AAPath;
import top.xxxlu.hotinfo.utils.AAToast;
import top.xxxlu.hotinfo.utils.AAViewCom;
import top.xxxlu.hotinfo.utils.Photo_Take_Util;
    ...
    private void initView(View view) {
        ...
        tv_gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* 取得相片后返回本画面 */
                getActivity().startActivityForResult(intent, Photo_Take_Util.selectPhoto);
                Photo_Dialog_Fragment.this.dismiss();
            }
        });
    }
